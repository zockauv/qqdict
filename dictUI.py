...
# Form implementation generated from reading ui file 'd:\My Documents\My-Programs\Dict\dictUI_v2.ui'
#
...
class WordInput(QtWidgets.QLineEdit):
    def __init__(self, focusWidget, parent=None):
        QtWidgets.QLineEdit.__init__(self, parent)
        self.focusWidget = focusWidget
    def keyPressEvent(self, event):
        if event.key() == QtCore.Qt.Key_Down:
            if self.focusWidget.count() > 0:
                self.focusWidget.setFocus()
                self.focusWidget.setCurrentRow(0)
